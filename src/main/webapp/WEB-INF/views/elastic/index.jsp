			...
			<div class="lnbDiv">
				<ul class="lnbList">
					<li class="lnbItem"><!--add class:selected-->
						<a href="#" class="Item"><span class="title">전체</span><span class="num">${index.total}</span></a>
					</li>
					<li class="lnbItem">
						<a href="#" class="Item"><span class="title">정부기관</span><span class="num">${index.elastic.stotal.item0}</span></a>
						<ul class="sub_list">
					...
					<li class="lnbItem">
						<a href="#" class="Item"><span class="title">국가법령/규칙</span><span class="num">${index.elastic.stotal.item1}</span></a>
						<ul class="sub_list">
							<li class="sub_item selected">
					...
					<li class="lnbItem">
						<a href="#" class="Item"><span class="title">해외뉴스</span><span class="num">${index.elastic.stotal.item2}</span></a>
						<ul class="sub_list">
							<li class="sub_item selected">
					...
					<ul class="list">
						<li class="listItem">
							<div class="titAreaWrap">
								<div class="titArea">
									<a href="javascript:void(0);" class="tit">${index.elastic.MOIS.stitle }</a>
								</div>
							</div>
							<div class="infoArea">
			...
			<div class="historydbDiv"><!--RIGHT > historyDiv/s-->
				...
				<div class="ctArea">
					<div class="data">
						<ul class="historyList">
							<li class="historyItem">
								<a href="javascript:void(0);" class="profile_img"><img src="resources/img/thumb_nodata.png" alt="thumb_nodata"></a>
								<div class="dbinfo">
									<p class="name">김전문</p>
							...
							<li class="historyItem">
								<a href="javascript:void(0);" class="profile_img"><img src="resources/img/thumb1.png" alt="thumb_nodata"></a>
								<div class="dbinfo">
									<p class="name">유전문</p>
									<p class="field">전분분야 : 남북협력</p>
									<p class="belong">소속/직책:서울대</p>
							...
							<li class="historyItem">
								<a href="javascript:void(0);" class="profile_img"><img src="resources/img/thumb2.png" alt="thumb_nodata"></a>
								<div class="dbinfo">
									<p class="name">박전문</p>
									<p class="field">전분분야 : 남북협력</p>
									<p class="belong">소속/직책:서울대</p>
							...
							<li class="historyItem">
								<a href="javascript:void(0);" class="profile_img"><img src="resources/img/thumb3.png" alt="thumb_nodata"></a>
								<div class="dbinfo">
									<p class="name">김전문</p>
									<p class="field">전분분야 : 남북협력</p>
									<p class="belong">소속/직책:서울대</p>
